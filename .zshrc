...
# # android stuffs
# # # adb
export PATH="${PATH}:/home/sringer/dev/android/sdk/platform-tools/"
...
alias lla='ls -la'
## reset xresources
alias resetXresources='xrdb -merge ~/.Xresources'
# show battery status
alias batteryStatus='acpi -b'
# keyboard backlight max
